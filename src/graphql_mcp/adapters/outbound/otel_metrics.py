...
- ``graphql_mcp.query.duration`` – histogram (seconds)
- ``graphql_mcp.query.count`` – counter
- ``graphql_mcp.query.errors`` – counter (only incremented when error_class != ok)
...
from graphql_mcp.adapters.outbound.otel_bootstrap import get_meter
