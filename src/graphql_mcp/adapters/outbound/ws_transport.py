...
Requires the ``websockets`` library (``pip install graphql-mcp[subscriptions]``).
"""
...
_WS_IMPORT_ERROR = (
    "websockets is required for subscription support. Install it with: pip install graphql-mcp[subscriptions]"
)
