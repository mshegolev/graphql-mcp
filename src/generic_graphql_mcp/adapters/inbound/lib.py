...
from generic_graphql_mcp.adapters.outbound.audit import emit_audit_log
from generic_graphql_mcp.adapters.outbound.file_source import FileSdlSource
from generic_graphql_mcp.adapters.outbound.gitlab_source import GitLabSource
from generic_graphql_mcp.adapters.outbound.http_transport import HttpTransport
from generic_graphql_mcp.adapters.outbound.introspection_source import IntrospectionSource
from generic_graphql_mcp.adapters.outbound.oauth2 import OAuth2TokenManager
from generic_graphql_mcp.adapters.outbound.otel_metrics import record_query_metrics
from generic_graphql_mcp.adapters.outbound.query_guard import check_mutation_guard
from generic_graphql_mcp.adapters.outbound.schema_analyzer import SchemaAnalyzer
from generic_graphql_mcp.adapters.outbound.service_sdl_source import ServiceSdlSource
...
if TYPE_CHECKING:
    ...
    from generic_graphql_mcp.ports.schema_source import SchemaSource
...
class GraphQLClient:
    """Library-first facade for generic-graphql-mcp.
    ...
    def subscribe(
        ...
        """
        from generic_graphql_mcp.adapters.outbound.sync_ws_transport import SyncWSTransport
