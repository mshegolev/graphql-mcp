...
# ---------------------------------------------------------------------------
# Test Group 7: entities() — ENT-01
# ---------------------------------------------------------------------------


class TestEntities:
    """Tests for GraphQLClient.entities()."""

    @respx.mock
    def test_entities_returns_query_result_with_data(self) -> None:
        ...
        client = _make_client()
        result = client.entities([{"__typename": "Product", "id": "123"}])
    ...
    @respx.mock
    def test_entities_sends_representations_as_variables(self) -> None:
    ...
    def test_entities_no_transport_returns_transport_error(self) -> None:
    ...
    def test_entities_does_not_trigger_mutation_guard(self) -> None:
    ...
    @respx.mock
    def test_entities_transport_error(self) -> None:
    ...
    @respx.mock
    def test_entities_graphql_error(self) -> None:
