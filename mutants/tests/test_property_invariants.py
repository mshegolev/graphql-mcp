...
def test_query_result_data_constraints():
    ...
    result_without_data = QueryResult(data=None, errors=["error"], error_class=ErrorClass.GRAPHQL)
...
def test_query_result_errors_constraints():
    ...
    result_with_errors = QueryResult(data=None, errors=["error1", "error2"], error_class=ErrorClass.GRAPHQL)
